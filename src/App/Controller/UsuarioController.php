...
class UsuarioController implements InterfaceController
{
    ...
    public function edit($id){
        //Comprobar si existe el usuario exista y cargar los datos
        $usuario = UsuarioModel::comprobarUsuario($id);
        if(!$usuario){
            $errores[]="usuario no encontrado";
            include_once DIRECTORIO_VISTAS."errorUser.php";
            exit();
        }else{
            include_once DIRECTORIO_VISTAS."Users/editUser.php";
        }
        //LLamar a una vista que nos muestre en un formulario los datos del usuario
